...
const DraggableSection = ({
  ...
  return (
    <div
      ref={ref}
      className={`p-2 mb-2 luxury-panel cursor-move ${
    ...
    >
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center">
          <button
            ...
            className={`p-1 rounded-full ${
              index === 0
                ...
                : "hover:bg-[var(--accent-color)] hover:text-[var(--bg-color)]"
            }`}
          >
            <ChevronUp size={16} />
          </button>
          ...
          <ArrowLeftRight
            size={16}
            className="mx-2 text-[var(--accent-color)]"
          />
          <button
  ...
  const handleTemplateSelect = async (template) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setGlobalCss(
          data.globalCss?.[0]?.cssFile?.content || data.globalCss || ""
        );
          ...
          return (
            <div>
              ...
              <div className="flex justify-between">
                <button onClick={handleNextStep} className="luxury-button">
                  Next
                </button>
                <button
                  onClick={() => {
      ...
      case 1:
        return (
          <DndProvider backend={HTML5Backend}>
            ...
            <button onClick={handleNextStep} className="luxury-button mt-4">
              Next
            </button>
          </DndProvider>
        );
          ...
          <div>
            ...
            {sections.map((section, index) => (
              <div key={section.id} className="mb-4 p-4 luxury-panel">
                <h4 className="text-md mb-2 text-[var(--accent-color)]">
                  Section {index + 1}
                </h4>
                <select
                  value={section.type}
